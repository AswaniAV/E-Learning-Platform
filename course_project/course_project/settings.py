...
SECRET_KEY = 'django-insecure-1u7&5$9(x+xxw&wgzj^gx6$v#h9-nn&c!i6in7l0q$dvlcmoja'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Corrected function name
]

MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Corrected function name
MEDIA_URL = '/media/' 
